...
public class DeveloperData implements ApplicationRunner {
    ...
    private void SetupDummyShowings() {
        ...
        Showing showing1 = new Showing(movieService.getMovieByImdbId("tt0088247"), 1, LocalDateTime.now().plusDays(1), 240L, 120);
        Showing showing2 = new Showing(movieService.getMovieByImdbId("tt21807222"), 2, LocalDateTime.now().plusDays(2), 300L, 180);
        Showing showing3 = new Showing(movieService.getMovieByImdbId("tt0033467"), 2, LocalDateTime.now().plusDays(1), 180L, 200);
        Showing showing4 = new Showing(movieService.getMovieByImdbId("tt9224104"), 1, LocalDateTime.now().plusDays(4), 240L, 99);
        Showing showing5 = new Showing(movieService.getMovieByImdbId("tt1517268"), 2, LocalDateTime.now().plusDays(3), 180L, 69.95);
        Showing showing6 = new Showing(movieService.getMovieByImdbId("tt9362722"), 1, LocalDateTime.now().plusDays(1), 240L, 120);
        Showing showing7 = new Showing(movieService.getMovieByImdbId("tt6791350"), 2, LocalDateTime.now().plusDays(6), 300L, 99);
